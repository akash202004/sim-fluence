...
import { SimulationSection } from "../simulation/Section/Simulation";
import { 
  Navbar, 
  NavBody, 
  NavItems, 
...
export default function ContentSimulationPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-black">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-6">
            Upload your content and let AI predict its performance across different social media platforms.
          </p>
        </motion.div>
      </div>
      ...
      {/* Simulation Section */}
      <div className="container mx-auto px-4 py-8">
        <SimulationSection userId={session?.user?.email || "anonymous"} />
      </div>
    </main>
  );
} 
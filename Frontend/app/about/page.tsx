        ...
        <div className="mt-20">
          ...
          >
            <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-2 max-w-xl text-sm text-gray-500 dark:text-gray-300">
                  <p>
                    At Sim-Fluence, we&apos;re on a mission to help content
                    creators, marketers, and businesses understand how their
                    content will perform before it goes live. By leveraging
                    advanced AI and machine learning, we simulate real audience
                    reactions to provide actionable insights.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-2 max-w-xl text-sm text-gray-500 dark:text-gray-300">
                  <p>
                    We envision a world where content creators can confidently
                    publish material knowing exactly how their audience will
                    respond. Our platform aims to eliminate the guesswork from
                    content strategy, helping you create more engaging and
                    effective content.
                  </p>
                </div>
              </div>
          ...
          >
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-2 text-sm text-gray-500 dark:text-gray-300">
                <p className="mb-4">
                  Sim-Fluence uses cutting-edge AI to create virtual personas
                  that mimic real human behavior. Our platform:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    Creates detailed audience simulations based on demographic
                    data
                  </li>
          ...
          >
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500 dark:text-gray-300">
              We&apos;re a passionate team of AI researchers, data scientists,
              and content strategists dedicated to transforming how content is
              created and shared.
            </p>
          </motion.div>
        </div>
